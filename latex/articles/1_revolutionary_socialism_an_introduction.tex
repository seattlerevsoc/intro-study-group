...
\emph{“The wrong people are in prison and the wrong people are free”}
...
\paragraph{Reform Capitalism into Socialism?}

\emph{“Capitalism is a tiger, not an onion!”}
...
\paragraph{What Kind of Revolution?}
...
\paragraph{What Is the Alternative to Capitalism?}

\emph{“No need for greed or hunger — A brotherhood of Man!”}
...
\paragraph{Is Marx’s Vision Possible?}

\emph{“Are workers organized enough to take power?”}
...
\begin{itemize}
	\item No support to the Democratic Party
	\item Mass struggle as opposed to terrorism or supporting politicians
	\item The need to fight oppression now to unify the working class
	\item Support for all workers struggles against exploitation
	\item Rejection of any support to Imperialism — -support for self-determination of oppressed nations
	\item Founding every movement on democratic principles
\end{itemize}
