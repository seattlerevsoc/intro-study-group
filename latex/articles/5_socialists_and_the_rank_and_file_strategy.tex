...
How socialists understand this bureaucracy factors heavily into how we develop strategies within union work. To quote British socialists Tony Cliff and Donny Gluckstein, in the second chapter of their book \emph{Marxism and Trade Union Struggle: The General Strike of 1926}:
...
The polish revolutionary Marxist Rosa Luxemburg was one of the first to recognize the character of this new layer when unions apparatuses became more established in Germany in the 1890s. She wrote in \emph{The Mass Strike}:
...
Led by former syndicalist William Z. Foster, the strategy was based on an uptick in strikes allowing for revolutionary socialists to attempt to build a broad socialist current within the union movement, using socialist politics, workplace struggle, and \emph{both} rank-and-file and socialist organization.
...
One of the Trotskyist leaders in Minneapolis, Farrell Dobbs, wrote two important books on the period, \emph{Teamster Rebellion} and \emph{Teamster Power}, which provide an invaluable case study in the successful implementation of a socialist rank-and-file strategy.
...
One of that period’s most prominent and successful revolutionary socialist organizers, Stan Weir, has a great book of essays called \emph{Single Jack Solidarity}, which details the struggles of that era.
...
The International Socialists participated in advancing this rank-and-file rebellion, which is detailed well in the books \emph{Rebel Rank and File}, edited by Aaron Brenner, Robert Brenner and Cal Winslow, and \emph{Rank-and-File Rebellion: Teamsters for a Democratic Union}.
