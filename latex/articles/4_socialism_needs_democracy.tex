...
\paragraph{The fight for socialism requires workers' democracy}
...
\paragraph{Capitalism is undemocratic in its essence}
...
\paragraph{Workers’ democracy and the transition to socialism}
